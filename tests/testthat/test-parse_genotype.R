...
test_that(".parse_genotype parses multi-allelic genotypes correctly", {
  expect_equal(.parse_genotype("0/1/2"), "HET_multi")
  expect_equal(.parse_genotype("0|2|3"), "HET_multi")
  expect_equal(.parse_genotype("1/2/3"), "HET_alt_multi")
  expect_equal(.parse_genotype("2|3|4"), "HET_alt_multi")
})
...
test_that(".parse_genotype handles missing and unknown cases", {
  ...
  expect_equal(.parse_genotype("5/5/5"), "HET_alt_multi")
})
